            ...
            <div className="cards card">
              ...
              <div className="items days">
                {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((day) => (
                  <div className="item" key={day}>{day}</div>
                ))}
              </div>

              <div className="items numbers">
                {[...Array(31).keys()].map((num) => (
                  <div className={num === 18 ? "item is-active" : "item"} key={num}>{num + 1}</div>
                ))}

                {[...Array(3).keys()].map((num) => (
                  <div className="item disable" key={num}>{num + 1}</div>
                ))}
              </div>
            </div>
          </div>
      ...
      <span className="today">Today</span>
          ...
          <div className="card transection" style={{ delay: "1.2s" }}>
            <div className="transection-header">
              <div className="head">Transections</div>
